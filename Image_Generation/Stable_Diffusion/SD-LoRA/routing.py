...
class MoD(nn.Module):
    ...
    def __init__(self, config, block):
        ...
        self.mlp_router = nn.Linear(config['hidden_size'], 1, bias=False)
    ...
    def forward(self, x, **kwargs):
        ...
        weights, selected_tokens = torch.topk(router_logits, top_k, dim=1, sorted=False) # weight is logits, selected_tokens is indices
